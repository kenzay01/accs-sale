        ...
        {menuItems.map((item) => (
          <li key={item.id}>
            <button
              ...
              className="block w-full text-left text-sm text-white hover:text-gray-300 hover:bg-gray-700 px-3 py-2 hover:rounded-lg transition-colors border-b-2 border-gray-700"
            >
              {item.label}
            </button>
          </li>
