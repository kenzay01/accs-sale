    ...
    <div className="min-h-screen bg-gray-900 text-white p-4 sm:p-6 md:p-8">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="py-2 px-4 bg-blue-500 text-white rounded-md hover:bg-blue-600 flex items-center gap-2"
            >
      ...
      {showOrdersManagement && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-4 mx-auto p-4 w-full max-w-7xl">
            <OrdersManagement onClose={() => setShowOrdersManagement(false)} />
          </div>
        </div>
      )}
    </div>
